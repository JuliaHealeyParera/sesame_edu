...
# summary statistics
summary(sesame$improve_body)
summary(sesame$improve_let)
summary(sesame$improve_form)
summary(sesame$improve_numb)
summary(sesame$improve_relat)
summary(sesame$improve_clasf)
