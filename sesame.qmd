...
body_final <- readRDS("models/adjusted/body_adj_betamod.rds")
letters_final <- readRDS( "models/adjusted/letters_adj_betamod.rds")
form_final <- readRDS("models/adjusted/form_adj_betamod.rds")
numb_final <- readRDS("models/adjusted/numb_adj_betamod.rds")
relat_final <- readRDS("models/adjusted/relat_adj_betamod.rds")
clasf_final <- readRDS("models/adjusted/clasf_adj_betamod.rds")
```
