...
print(paste('Body model BIC:', BIC(body_final)))
print(paste('Letters model BIC:', BIC(letters_final)))
print(paste('Form model BIC:', BIC(form_final)))
print(paste('Numbers model BIC:', BIC(numb_final)))
print(paste('Relational model BIC:', BIC(relat_final)))
print(paste('Classification model BIC:', BIC(clasf_final)))
...
print(paste('Adjusted body model RMSE:', round(rmse_body_final, 3)))
print(paste('Adjusted letters model RMSE:', round(rmse_letters_final,3)))
print(paste('Adjusted form model RMSE:', round(rmse_form_final,3)))
print(paste('Adjusted numbers model RMSE:', round(rmse_numb_final,3)))
print(paste('Adjusted relational model RMSE:', round(rmse_relat_final,3)))
print(paste('Adjusted classification model RMSE:', round(rmse_clasf_final,3)))
```
