...
sesame <- sesame |>
  mutate(
    improve_body = postbody - prebody,
    improve_let = postlet - prelet,
    improve_form = postform - preform,
    improve_numb = postnumb - prenumb,
    improve_relat = postrelat - prerelat,
    improve_clasf = postclasf - preclasf
  )
```
